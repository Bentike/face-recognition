...
class Register extends React.Component{
    ...
    onSubmit = () => {
        ...
        if(email.length && password.length && name.length > 0 ){
            fetch('https://mysterious-harbor-78970.herokuapp.com/register', {
            method: 'post',
        ...
        .then(user => {
            if(user.id){
                ...
                this.registerStatus("Registration Fail")
            }
        })
        .catch(err => {console.log(err)});
        }else{
            this.registerStatus("Invalid inputs")   
        }
    }
                ...
                <main className="pa4 black-80">
                 <div className="measure center">
                     ...
                     <div className="">
                      ...
                      <p className="f6 fw6 ph0 mh0" id="message"></p>
                   </div>
               </main>
             </article>  
        )   
